...
public class KafkaErrorHandlerConfigurations {
    ...
    public DefaultErrorHandler errorHandler(
            ...
            KafkaTemplate<String, SpecificRecordBase> dlqKafkaTemplate
    ) {
        final DefaultErrorHandler handler = getDefaultErrorHandler(dlqKafkaTemplate);
    ...
    private DefaultErrorHandler getDefaultErrorHandler(final KafkaTemplate<String, SpecificRecordBase> dlqKafkaTemplate) {
        ...
        final ExponentialBackOffWithMaxRetries backOff =
                new ExponentialBackOffWithMaxRetries(kafkaDlqProperties.maxRetries());
